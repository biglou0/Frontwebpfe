...
<div>
  ...
  />
                ...
                <div className="py-2">
                    <h3 className="font-bold text-2xl mb-1">{Nom} {Prenom}</h3>
                    ...
                    <AlternateEmailIcon className="h-5 w-5 text-gray-400 mr-1" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" /> {email}
                    </div>

                    <div className="text-gray-700 items-center">
                    <ContactPageIcon className="h-5 w-5 text-gray-400 mr-1" fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" /> {role}
                    </div>
                </div>
